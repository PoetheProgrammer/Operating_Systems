...
main(void) {
  ...
  for(;;) {
    ...
    printf(1, "Starting System V Init\n");
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 466:	0f b6 80 2c 0b 00 00 	movzbl 0xb2c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5a1:	75 07                	jne    5aa <printf+0xe1>
          s = "(null)";
 5a3:	c7 45 f4 d2 08 00 00 	movl   $0x8d2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 668:	a1 48 0b 00 00       	mov    0xb48,%eax
...
free(void *ap)
{
 ...
 733:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 738:	c9                   	leave  
 739:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7bd:	c7 45 f0 40 0b 00 00 	movl   $0xb40,-0x10(%ebp)
 7c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c7:	a3 48 0b 00 00       	mov    %eax,0xb48
 7cc:	a1 48 0b 00 00       	mov    0xb48,%eax
 7d1:	a3 40 0b 00 00       	mov    %eax,0xb40
    base.s.size = 0;
 7d6:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 7dd:	00 00 00 
  }
 ...
 833:	a3 48 0b 00 00       	mov    %eax,0xb48
      return (void*)(p + 1);
